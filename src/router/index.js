    ...
    children: [
      {
        ...
        name: "pcHome",
        meta: { title: "首页", noCache: true, isPC: true },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        name: "cardHome",
        meta: { title: "名片", noCache: true , isPC: true},
      },
      {
        path: "/card_plugin",
        component: () => import("@/views/pc/card_plugin"),
        name: "card_plugin",
        meta: { title: "名片导航", noCache: true , isPC: true},
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        name: "OrderPage",
        meta: { title: "订单", noCache: true , isPC: true},
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        name: "goodsPage",
        meta: { title: "商品列表", noCache: true, isPC: true },
      },
      {
        path: "goodsEdit/:id?",
        component: () => import("@/views/pc/goodsEdit"),
        name: "goodsEdit",
        meta: { title: "商品编辑", noCache: true, isPC: true },
      },
    ],
  },
  {
